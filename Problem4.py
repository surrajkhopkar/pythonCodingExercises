...
Problem Description:
You are given an integer n. Your task is to return a right-angled triangle pattern of '*' where 
each side has n characters, represented as a list of strings. 
...
def create_rectangle(n):
    rectangle = []
    for i in range(1,n+1):
        rectangle.append("*" * i)
    return rectangle

print(create_rectangle(5))
print(create_rectangle(10))